...
func (m *Container) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CpuLimit != 0 {
		dAtA[i] = 0x2d
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.CpuLimit))))
		i += 4
	}
	if m.MemoryLimit != 0 {
		dAtA[i] = 0x30
	...
	if m.Rbps != 0 {
		dAtA[i] = 0x5d
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.Rbps))))
		i += 4
	}
	if m.Wbps != 0 {
		dAtA[i] = 0x65
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.Wbps))))
		i += 4
	}
	if m.Key != 0 {
		dAtA[i] = 0x68
	...
	if m.NetRcvdPs != 0 {
		dAtA[i] = 0x75
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.NetRcvdPs))))
		i += 4
	}
	if m.NetSentPs != 0 {
		dAtA[i] = 0x7d
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.NetSentPs))))
		i += 4
	}
	if m.NetRcvdBps != 0 {
		dAtA[i] = 0x85
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.NetRcvdBps))))
		i += 4
	}
	if m.NetSentBps != 0 {
		dAtA[i] = 0x8d
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.NetSentBps))))
		i += 4
	}
	if m.UserPct != 0 {
		dAtA[i] = 0x95
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.UserPct))))
		i += 4
	}
	if m.SystemPct != 0 {
		dAtA[i] = 0x9d
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.SystemPct))))
		i += 4
	}
	if m.TotalPct != 0 {
		dAtA[i] = 0xa5
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.TotalPct))))
		i += 4
	}
	if m.MemRss != 0 {
		dAtA[i] = 0xa8
...
func (m *ProcessStat) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ContainerRbps != 0 {
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ContainerRbps))))
		i += 4
	}
	if m.ContainerWbps != 0 {
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ContainerWbps))))
		i += 4
	}
	if m.ContainerKey != 0 {
		dAtA[i] = 0x90
	...
	if m.ContainerNetRcvdPs != 0 {
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ContainerNetRcvdPs))))
		i += 4
	}
	if m.ContainerNetSentPs != 0 {
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ContainerNetSentPs))))
		i += 4
	}
	if m.ContainerNetRcvdBps != 0 {
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ContainerNetRcvdBps))))
		i += 4
	}
	if m.ContainerNetSentBps != 0 {
		...
		dAtA[i] = 0x1
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ContainerNetSentBps))))
		i += 4
	}
	if m.VoluntaryCtxSwitches != 0 {
		dAtA[i] = 0xc0
...
func (m *IOStat) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ReadRate != 0 {
		dAtA[i] = 0xd
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ReadRate))))
		i += 4
	}
	if m.WriteRate != 0 {
		dAtA[i] = 0x15
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.WriteRate))))
		i += 4
	}
	if m.ReadBytesRate != 0 {
		dAtA[i] = 0x1d
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ReadBytesRate))))
		i += 4
	}
	if m.WriteBytesRate != 0 {
		dAtA[i] = 0x25
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.WriteBytesRate))))
		i += 4
	}
	return i, nil
}
